...
const PurchaseSuccessPage = () => {
  ...
  return (
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="  rounded-lg p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold text-[#fffadc]">
                #12345
              </span>
            </div>
          ...
          <div className="space-y-4">
            <button
              className="w-full bg-[#fffadc] hover:bg-[#e1d06d] text-black font-bold py-2 px-4
   rounded-lg transition duration-300 flex items-center justify-center"
            ...
            <Link
              to={"/"}
              className="w-full border border-stone-900    text-[#fffadc] font-bold py-2 px-4 
  rounded-lg transition duration-300 flex items-center justify-center"
            >
              Continue Shopping
